...
const OperationAppAdminDailyBuyReward = "/api.App/AdminDailyBuyReward"
...
const OperationAppTestCreateAccount = "/api.App/TestCreateAccount"
...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	...
	r.GET("/api/admin_dhb/daily_buy_reward", _App_AdminDailyBuyReward0_HTTP_Handler(srv))
	...
	r.GET("/api/admin_dhb/create_account", _App_TestCreateAccount0_HTTP_Handler(srv))
}
...
func _App_Deposit50_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DepositRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppDeposit5)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.Deposit5(ctx, req.(*DepositRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _App_AdminVipDelete0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationAppAdminVipDelete)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminVipDelete(ctx, req.(*AdminVipDeleteRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminVipDeleteReply)
		return ctx.Result(200, reply)
	}
}
...
func _App_AdminDailyBuyReward0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminDailyLocationRewardRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppAdminDailyBuyReward)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminDailyBuyReward(ctx, req.(*AdminDailyLocationRewardRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _App_TestCreateAccount0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in TestCreateAccountRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppTestCreateAccount)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.TestCreateAccount(ctx, req.(*TestCreateAccountRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*TestCreateAccountReply)
		return ctx.Result(200, reply)
	}
}
...
type AppHTTPClient interface {
	...
	AdminDailyBuyReward(ctx context.Context, req *AdminDailyLocationRewardRequest, opts ...http.CallOption) (rsp *AdminDailyLocationRewardReply, err error)
	...
	TestCreateAccount(ctx context.Context, req *TestCreateAccountRequest, opts ...http.CallOption) (rsp *TestCreateAccountReply, err error)
...
func (c *AppHTTPClientImpl) AdminDailyBuyReward(ctx context.Context, in *AdminDailyLocationRewardRequest, opts ...http.CallOption) (*AdminDailyLocationRewardReply, error) {
	var out AdminDailyLocationRewardReply
	pattern := "/api/admin_dhb/daily_buy_reward"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppAdminDailyBuyReward))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) AdminVipDelete(ctx context.Context, in *AdminVipDeleteRequest, opts ...http.CallOption) (*AdminVipDeleteReply, error) {
	var out AdminVipDeleteReply
...
func (c *AppHTTPClientImpl) TestCreateAccount(ctx context.Context, in *TestCreateAccountRequest, opts ...http.CallOption) (*TestCreateAccountReply, error) {
	var out TestCreateAccountReply
	pattern := "/api/admin_dhb/create_account"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppTestCreateAccount))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
